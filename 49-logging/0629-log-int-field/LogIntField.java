// slf4j 2 fluent API + logback ListAppender (in-memory record capture). Run: jbang LogIntField.java
...
public class LogIntField {
  public static void main(String[] a) {
    ...
    log.atInfo().setMessage("processed").addKeyValue("count", 5).log();
