// slf4j 2 fluent API + logback ListAppender (in-memory record capture). Run: jbang LogWarn.java
...
public class LogWarn {
  public static void main(String[] a) {
    ...
    log.atWarn().setMessage("low disk").log();

    for (ILoggingEvent e : app.list) {
      String level = e.getLevel().toString().toLowerCase();  // WARN -> warn
