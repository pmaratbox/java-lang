...
public class LogLevelFilter {
  public static void main(String[] a) {
    ...
    root.setLevel(ch.qos.logback.classic.Level.WARN); // minimum level: INFO records are dropped

    org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger("demo");
    log.atInfo().setMessage("hidden").log();          // below WARN -> suppressed, never captured
    log.atWarn().setMessage("visible").log();         // at WARN -> captured
