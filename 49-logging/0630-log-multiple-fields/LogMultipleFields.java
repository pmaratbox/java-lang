// slf4j 2 fluent API + logback ListAppender (in-memory record capture). Run: jbang LogMultipleFields.java
...
public class LogMultipleFields {
  public static void main(String[] a) {
    ...
    log.atInfo().setMessage("request")
       .addKeyValue("method", "GET")   // string field
       .addKeyValue("status", 200)     // integer field
       .log();
