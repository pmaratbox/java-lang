...
public class DeleteRow {
    public static void main(String[] args) throws Exception {
        ...
        // Remove the persisted entity with id = 1 via the jOOQ delete DSL.
        db.deleteFrom(table("users"))
          .where(field("id", Integer.class).eq(1))
          .execute();
        ...
        for (org.jooq.Record rec : r) {
            System.out.println(rec.get("name", String.class));
        }
    }
}
